...
import { ChapterGenerateClient } from '@/components/chapter'
...
export default async function ChapterGeneratePage({
  params,
}: {
  ...
  return <ChapterGenerateClient projectId={projectId} chapterId={chapterId} initialChapter={chapter} />
}
