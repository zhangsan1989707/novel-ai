...
CREATE UNIQUE INDEX IF NOT EXISTS "rag_documents_project_source_unique"
...
CREATE INDEX IF NOT EXISTS "rag_documents_project_chapter_idx"
ON "rag_documents" ("project_id", "chapter_no");

CREATE INDEX IF NOT EXISTS "rag_documents_project_title_idx"
ON "rag_documents" ("project_id", "title");
